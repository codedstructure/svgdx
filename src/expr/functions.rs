...
impl FromStr for Function {
    ...
    fn from_str(value: &str) -> Result<Self> {
        Ok(match value {
            ...
            "join" => Self::Join,
            "_" => Self::Text,
            _ => return Err(Error::Parse(format!("Unknown function: '{value}'"))),
        })
    }
}
...
pub fn eval_function(
    ...
    let e = match fun {
        ...
        Function::Max => args
            ...
            .ok_or_else(|| Error::InvalidData("max() requires at least one argument".to_owned()))?,
        Function::Min => args
            .number_list()?
            .into_iter()
            .min_by(|a, b| a.total_cmp(b))
            .ok_or_else(|| Error::InvalidData("min() requires at least one argument".to_owned()))?,
        ...
        Function::If => {
            ...
            return Err(Error::Parse("if() requires three arguments".to_string()));
        }
        Function::Not => {
